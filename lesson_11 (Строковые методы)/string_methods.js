...
// -------------------------------------
// String.startsWith(subtring) - метод, который проверяет, начинается ли наша строка с указанной подстроки
// возвращает булевый тип (true, false)
...
// ----------------------------
// String.endsWith(subtring) - метод, который проверяет, заканчивается ли наша строка с указанной подстроки
// возвращает булевый тип (true, false)
// let string = 'Привет мой друг!'
